      ...
      <Alert
        message={
          <div style={{ textAlign: 'center' }}>
            <Typography.Text>
              Thank you for your continued support. To align with the evolving landscape of CKB ecosystem,{' '}
              <strong>Force Bridge will enter the phase-out stage on June 1, 2025</strong>, and{' '}
